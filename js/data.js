...
const BLOG_INFO = {
  ...
  tagline: "Revista y Blog de Ética, Sociedad y Futuro Tecnológico",
  ...
  edition: "Vol. 1 · Edición Especial: Ética Práctica y Nuevas Tecnologías",
...
const INITIAL_TRABAJOS = [
  ...
  },
  {
    ...
    author: "Diego Esquivel, Naomi Quiroz y Equipo DeonTech",
    authorRole: "Software y Sistemas",
    module: "Módulo 1 — Aspectos Básicos de la Ética",
    week: "Semana 4",
    focusArea: "Códigos Deontológicos y Negligencias",
...
function loadTrabajos() {
  try {
    const saved = localStorage.getItem("deontech_magazine_articles_v4");
    if (saved) {
...
function saveTrabajos(trabajos) {
  try {
    localStorage.setItem("deontech_magazine_articles_v4", JSON.stringify(trabajos));
  } catch (e) {
